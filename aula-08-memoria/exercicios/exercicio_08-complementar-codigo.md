...
> **Este é o exercício complementar de código da aula 08.** O que vale nota é
> o [enunciado.md](exercicio_08.md), que é de projeto e alimenta a Parte 2 do
> trabalho. Este implementa, no repositório do case, as decisões que aquele
> obriga a tomar — e o outro complementar, o
> [08-complementar.md](exercicio_08-complementar.md), exercita a classificação do que
> não merece memória.
